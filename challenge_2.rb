...
the_payment=pmt(option["annual_rate"],number_of_monthly_payments, principal_amount)
puts "The monthly payment from #{option["bank"]} will be, #{the_payment.round(2)}"
end
# Your code goes here.
# You shouldn't have to write code or change code anywhere else.
# puts "$xyz." "The monthly payment from Elm Street Bank will be $xyz."
# loan_quotes.each ...
# ==============================================================
